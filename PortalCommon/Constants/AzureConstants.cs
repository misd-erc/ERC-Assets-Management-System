...
namespace PortalCommon.Constants
{
    public static class AzureConstants
    {
        ...
        public static readonly string AUTHORITY = EnvironmentConstants.ERC_AMS_AZURE_AUTHORITY; //https://login.microsoftonline.com/{tenant}
        public static readonly string GRAPH_SCOPE = EnvironmentConstants.ERC_AMS_AZURE_GRAPH_SCOPE; //https://graph.microsoft.com/.default

          ...
          {breakdown.length > 0 && (
            <div className="border rounded-lg overflow-hidden">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {breakdown.map((cat, i) => (
                    <tr key={cat.name} className={`border-t ${i % 2 === 0 ? 'bg-white' : 'bg-slate-50'} hover:bg-blue-50/50 transition-colors`}>
                ...
                <tfoot>
                  <tr className="border-t-2 border-blue-300 bg-blue-50 font-bold">
                    ...
                    <td className="p-3 text-right text-blue-900">{totalPPE.toLocaleString()} units</td>
